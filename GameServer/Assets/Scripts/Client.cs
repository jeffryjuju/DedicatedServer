...
public class Client
{
    ...
    public class UDP
    {
        ...
        /// Prepares received data to be used by the appropriate packet handler methods.
        /// </summary>
        /// <param name="_packetData">The packet containing the received data.</param>
    ...
    /// <summary>
    /// Properly disconnects all connection and destroying related game object.
    /// </summary>
    ...
    /// </summary>
    /// <param name="_playerName">The player's name</param>
    public void SendIntoGame(string _playerName)
    {
        player = NetworkManager.instance.InstantiatePlayer();
        player.Initialize(id, _playerName);

        // load all clients that are already connected
        ...
        // send the new Player information to all clients (including himself)
        foreach (Client _client in Server.clients.Values)
        {
            if (_client.player != null)
            {
